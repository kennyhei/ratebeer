...
describe "Beerlist page" do
  ...
  it "sorts beers by style when clicking label", :js => true do
    visit beerlist_path

    find_link('style').native.send_keys([:return])
  ...
  it "sorts beers by brewery when clicking label", :js => true do
    visit beerlist_path

    find_link('brewery').native.send_keys([:return])
